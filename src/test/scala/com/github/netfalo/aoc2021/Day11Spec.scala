...
class Day11Spec extends AnyFlatSpec with Matchers {
  ...
  it should "run 1 step" in {
    ...
    smallGrid.stepN(1) shouldEqual(expected, 9)
  }
  ...
  it should "run 2 step" in {
    ...
    smallGrid.stepN(2) shouldEqual(expected, 9)
  }
  ...
  it should "run 1 step on large" in {
    ...
    parseGrid(largeExample).stepN(1) shouldEqual(expected, 0)
  }
  ...
  it should "run 2 steps" in {
    ...
    parseGrid(largeExample).stepN(2) shouldEqual(expected, 35)
  }
